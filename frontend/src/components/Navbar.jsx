...
>
  {/* Icon */}
  <div className="w-9 h-9 md:w-11 md:h-11 flex items-center justify-center rounded-full 
  ...
  <span className="text-2xl md:text-3xl font-extrabold 
                   bg-gradient-to-r from-white md:from-blue-700 md:to-indigo-700 
                   to-blue-200 bg-clip-text text-transparent 
